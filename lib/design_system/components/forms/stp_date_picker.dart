...
/// Example:
/// ```dart
/// final selectedDate = await showSTPDatePicker(
///   context: context,
...
/// );
/// ```
Future<DateTime?> showSTPDatePicker({
  ...
  return showDialog<DateTime>(
    context: context,
    builder: (context) => _STPDatePickerDialog(
...
class _STPDatePickerDialog extends StatefulWidget {
  const _STPDatePickerDialog({
  ...
  @override
  State<_STPDatePickerDialog> createState() => _STPDatePickerDialogState();
}

enum _PickerMode { date, month, year }

class _STPDatePickerDialogState extends State<_STPDatePickerDialog> {
