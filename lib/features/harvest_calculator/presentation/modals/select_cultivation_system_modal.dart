...
class SelectCultivationSystemModal extends StatefulWidget {
  /// Creates a new instance of [SelectCultivationSystemModal].
  const SelectCultivationSystemModal({
  ...
  @override
  State<SelectCultivationSystemModal> createState() =>
      _SelectCultivationSystemModalState();
}

class _SelectCultivationSystemModalState
    extends State<SelectCultivationSystemModal> {
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          HarvestCalculatorConstants
                              .subtitleSelectCultivationSystem,
            ...
            Flexible(
              child: Padding(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    _CultivationSystemOption(
                      label: HarvestCalculatorConstants.systemRAS,
                      description: HarvestCalculatorConstants.descriptionRAS,
                      isSelected:
                          _selectedValue ==
                          HarvestCalculatorConstants.systemRAS,
                      onTap: () {
                        setState(() {
                          _selectedValue = HarvestCalculatorConstants.systemRAS;
                        });
                      },
                    ),
                    const SizedBox(height: 12),
                    _CultivationSystemOption(
                      label: HarvestCalculatorConstants.systemBiofloc,
                      description:
                          HarvestCalculatorConstants.descriptionBiofloc,
                      isSelected:
                          _selectedValue ==
                          HarvestCalculatorConstants.systemBiofloc,
                      onTap: () {
                        setState(() {
                          _selectedValue =
                              HarvestCalculatorConstants.systemBiofloc;
                    ...
                    const SizedBox(height: 12),
                    _CultivationSystemOption(
                      label: HarvestCalculatorConstants.systemTraditional,
                      description:
                          HarvestCalculatorConstants.descriptionTraditional,
                      isSelected:
                          _selectedValue ==
                          HarvestCalculatorConstants.systemTraditional,
                      onTap: () {
                        setState(() {
                          _selectedValue =
                              HarvestCalculatorConstants.systemTraditional;
...
/// Option card for cultivation system selection.
class _CultivationSystemOption extends StatelessWidget {
  /// Creates a new instance of [_CultivationSystemOption].
  const _CultivationSystemOption({
    required this.label,
