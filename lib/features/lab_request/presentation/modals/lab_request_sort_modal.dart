...
/// Modal bottom sheet for sorting lab requests.
class LabRequestSortModal extends StatefulWidget {
  /// Creates a new instance of [LabRequestSortModal].
  const LabRequestSortModal({
  ...
  @override
  State<LabRequestSortModal> createState() => _LabRequestSortModalState();
}

class _LabRequestSortModalState extends State<LabRequestSortModal> {
  ...
  Widget build(BuildContext context) {
    final options = [
      LabRequestConstants.sortDateNewest,
      LabRequestConstants.sortDateOldest,
      LabRequestConstants.sortStatus,
      LabRequestConstants.sortCustomerAZ,
      LabRequestConstants.sortCustomerZA,
    ];
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(
                      LabRequestConstants.buttonSort,
